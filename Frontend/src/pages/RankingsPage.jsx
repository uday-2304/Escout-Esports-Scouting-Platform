...
import { FaSearch, FaTrophy, FaUserAstronaut, FaGlobe } from "react-icons/fa";
...
const RankingsPage = () => {
  const [viewMode, setViewMode] = useState("ESPORTS"); // ESPORTS | PLATFORM
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setEsportsData((prevData) => {
        ...
        const gamePlayers = [...newData[activeGame]];
        ...
        newData[activeGame] = rankedPlayers;
        return newData;
      });
      ...
      <div className="container">
        ...
        <div className="controls-bar">
          <div className="game-tabs">
            {Object.keys(INITIAL_DATA).map((game) => (
              <button
                key={game}
